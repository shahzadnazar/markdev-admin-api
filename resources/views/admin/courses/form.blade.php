        ...
        <div class="grid gap-6">
            <x-card class="space-y-5">
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    <x-form.input label="Slug" name="slug" :value="$course?->slug" hint="Leave blank to generate from the title." />
                ...
                <x-form.textarea label="Excerpt" name="excerpt" :value="$course?->excerpt" rows="2" hint="One-sentence pitch shown on catalog cards." />
            ...
            <x-card class="space-y-5">
                <p class="eyebrow">Media &amp; pricing</p>
                <div class="grid items-start gap-5 sm:grid-cols-2">
                    ...
                    <div class="space-y-5">
                        ...
                        <div x-show="! free" x-cloak>
                            <x-form.input label="Price (USD)" name="price" type="number" step="0.01" min="0" :value="$course?->price" />
                        </div>
                    </div>
                </div>
            </x-card>
