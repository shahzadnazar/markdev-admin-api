<x-admin.layout :title="$course->title">
    ...
    <div class="max-w-4xl space-y-5">
        ...
        {{-- Course-level resources. The same partial the Course Content list
             uses, so the two cannot drift; here the owning course is already
             known, so it is passed in and the form needs no picker. --}}
        @include('admin.courses._resources', ['resources' => $course->resources, 'course' => $course])
