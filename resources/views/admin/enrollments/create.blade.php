    ...
    <div x-data="enrollPicker()" x-effect="if (feeOnly) withPlan = true">
        ...
        <x-card :padding="false" class="mb-4">
            <div class="flex flex-wrap items-center gap-2 px-4 py-2.5">
                ...
                <form method="GET" action="{{ route('admin.enrollments.create') }}" class="ml-auto flex flex-wrap items-center gap-2" data-live-search="#enroll-results">
                    @if ($tab === 'unenrolled')
        ...
        <div id="enroll-results" class="transition-opacity duration-150">
            @include('admin.enrollments._create-results')
        </div>
