<x-admin.layout title="Dashboard">
    ...
    <div class="mt-5 grid gap-5 sm:grid-cols-3">
        ...
        {{-- Only for someone allowed to see money. The controller leaves
             pending_fees null for everyone else and never runs the query, so
             there is no figure in the response to hide. --}}
        @can('billing.view')
